...
void Game::InitMeshes()
{
	...
	for (auto i = 0; i < 15; ++i)
	{
		...
		switch (i)
		{
		case 0: mountainRock.SetTransform(glm::vec3(700.0f, 55.0f, 300.0f), glm::vec3(0.0f, 1.0f, 0.0f), 180.0f, glm::vec3(20.0f, 36.0f, 20.0f)); break; //gotowe
		case 1: mountainRock.SetTransform(glm::vec3(200.0f, 55.0f, 200.0f), glm::vec3(0.0f, 1.0f, 0.0f), 180.0f, glm::vec3(20.0f, 36.0f, 20.0f)); break; //gotowe
		case 2: mountainRock.SetTransform(glm::vec3(286.0f, 63.0f, 320.0f), glm::vec3(0.0f, 1.0f, 0.0f), 100.0f, glm::vec3(20.0f, 36.0f, 20.0f)); break; //gotowe
		case 3: mountainRock.SetTransform(glm::vec3(30.0f, 60.0f, 750.0f), glm::vec3(0.0f, 1.0f, 0.0f), 180.0f, glm::vec3(20.0f, 36.0f, 20.0f)); break;  //gotowe
		case 4: mountainRock.SetTransform(glm::vec3(250.0f, 55.0f, 520.0f), glm::vec3(0.0f, 1.0f, 0.0f), 100.0f, glm::vec3(20.0f, 36.0f, 20.0f)); break; //gotowe
		case 5: mountainRock.SetTransform(glm::vec3(743.0f, 55.0f, 516.0f), glm::vec3(0.0f, 1.0f, 0.0f), 100.0f, glm::vec3(20.0f, 36.0f, 20.0f)); break; //gotowe
		case 6: mountainRock.SetTransform(glm::vec3(500.0f, 55.0f, 300.0f), glm::vec3(0.0f, 1.0f, 0.0f), 100.0f, glm::vec3(20.0f, 36.0f, 20.0f)); break; //gotowe
		case 7: mountainRock.SetTransform(glm::vec3(342.0f, 55.0f, 523.0f), glm::vec3(0.0f, 1.0f, 0.0f), 100.0f, glm::vec3(20.0f, 36.0f, 20.0f)); break; //gotowe
		case 8: mountainRock.SetTransform(glm::vec3(220.0f, 55.0f, 359.0f), glm::vec3(0.0f, 1.0f, 0.0f), 100.0f, glm::vec3(20.0f, 36.0f, 20.0f)); break; //gotowe
		case 9: mountainRock.SetTransform(glm::vec3(405.0f, 55.0f, 205.0f), glm::vec3(0.0f, 1.0f, 0.0f), 100.0f, glm::vec3(20.0f, 36.0f, 20.0f)); break; //gotowe
		case 10: mountainRock.SetTransform(glm::vec3(440.0f, 55.0f, 430.0f), glm::vec3(0.0f, 1.0f, 0.0f), 100.0f, glm::vec3(20.0f, 36.0f, 20.0f)); break; //gotowe
		case 11: mountainRock.SetTransform(glm::vec3(140.0f, 55.0f, 450.0f), glm::vec3(0.0f, 1.0f, 0.0f), 100.0f, glm::vec3(20.0f, 36.0f, 20.0f)); break; //gotowe
		case 12: mountainRock.SetTransform(glm::vec3(350.0f, 55.0f, 400.0f), glm::vec3(0.0f, 1.0f, 0.0f), 100.0f, glm::vec3(20.0f, 36.0f, 20.0f)); break; //gotowe
		case 13: mountainRock.SetTransform(glm::vec3(600.0f, 50.0f, 200.0f), glm::vec3(0.0f, 1.0f, 0.0f), 180.0f, glm::vec3(20.0f, 36.0f, 20.0f)); break; //gotowe
		default: break;                              //             //leci pod jowisza i w 2 strone
		}
...
void Game::RenderScene()
{
	...
	{
		m_texts[2].SetText("Przejmowanie terenu: " + std::to_string((int)m_dataTransmitTimer) + "%");
	}
	else
	{
		m_texts[2].SetSpacing(0.7f);
		m_texts[2].SetText("Teren przejêty! Pokonaj pozosta³ych Amongusów");
	}
