...
bool Renderer::InitSDLAndOpenGL()
{
	...
	window = SDL_CreateWindow("Programowanie 3D i projektowanie kart graficznych PROJEKT", SDL_WINDOWPOS_CENTERED, SDL_WINDOWPOS_CENTERED, m_screenWidth, m_screenHeight, SDL_WINDOW_OPENGL);
	if (window == nullptr)
	{
